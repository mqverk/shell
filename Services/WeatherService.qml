...
Item {
    ...
    // --- Configuration ---
    property int refreshInterval: 30 * 60 * 1000 // 30 Minutes

    // --- Weather Codes Map ---
    property var _weatherCodes: ({
        0:  { day: "", night: "", desc: "Clear sky" },
        1:  { day: "", night: "", desc: "Mainly clear" },
        2:  { day: "", night: "", desc: "Partly cloudy" },
        3:  { day: "", night: "", desc: "Overcast" },
        45: { day: "", night: "", desc: "Fog" },
        48: { day: "", night: "", desc: "Rime fog" },
        51: { day: "", night: "", desc: "Light drizzle" },
        53: { day: "", night: "", desc: "Mod. drizzle" },
        55: { day: "", night: "", desc: "Dense drizzle" },
        61: { day: "", night: "", desc: "Slight rain" },
        63: { day: "", night: "", desc: "Mod. rain" },
        65: { day: "", night: "", desc: "Heavy rain" },
        71: { day: "", night: "", desc: "Slight snow" },
        73: { day: "", night: "", desc: "Mod. snow" },
        75: { day: "", night: "", desc: "Heavy snow" },
        80: { day: "", night: "", desc: "Rain showers" },
        81: { day: "", night: "", desc: "Mod. showers" },
        82: { day: "", night: "", desc: "Violent showers" },
        95: { day: "ﱈ", night: "ﱈ", desc: "Thunderstorm" },
        96: { day: "ﱈ", night: "ﱈ", desc: "Thunderstorm" },
        99: { day: "ﱈ", night: "ﱈ", desc: "Thunderstorm" }
    })
                    ...
                    try {
                        ...
                        for(var i = 1; i < 6; i++) {
                            ...
                            newForecast.push({
                                ...
                                icon: fInfo.day, // Always use day icon for forecast
